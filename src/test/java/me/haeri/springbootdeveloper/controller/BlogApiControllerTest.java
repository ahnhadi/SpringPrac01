...
import me.haeri.springbootdeveloper.repository.UserRepository;
...
class BlogApiControllerTest {
  ...
  public void addArticle() throws Exception{
    ...
    // when
    // 설정한 내용을 바탕으로 요청 전송
    ResultActions results = mockMvc.perform(post(url).contentType(MediaType.APPLICATION_JSON_VALUE)
  ...
  @DisplayName("findAriticle : 블로그 글 조회에 성공한다.")
  @Test
  ...
  public void updateArticle() throws Exception {
    ...
    // when
    ResultActions resultActions = mockMvc.perform(patch(url, savedArticle.getId()).contentType(MediaType.APPLICATION_JSON_VALUE)
