package me.haeri.springbootdeveloper.config;

import static org.springframework.boot.autoconfigure.security.servlet.PathRequest.toH2Console;

import lombok.RequiredArgsConstructor;
import me.haeri.springbootdeveloper.config.jwt.TokenProvider;
import me.haeri.springbootdeveloper.config.oauth.OAuth2AuthorizationRequestBasedOnCookieRepository;
import me.haeri.springbootdeveloper.config.oauth.OAuth2SuccessHandler;
import me.haeri.springbootdeveloper.config.oauth.OAuth2UserCustomService;
import me.haeri.springbootdeveloper.repository.RefreshTokenRepository;
import me.haeri.springbootdeveloper.service.UserService;
...
//        .logout() // 로그아웃 설정
//        .logoutSuccessUrl("/login")
//        .invalidateHttpSession(true) // 로그아웃 이후에 세션 전체 삭제 true
//        .and()
//        .csrf().disable()
//        .build();
//  }
